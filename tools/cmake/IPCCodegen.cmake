...
# steamflipper_add_ipc_codegen(<out_var> IDL <file.steamd> CPP_OUT <dir>)
#
...
function(steamflipper_add_ipc_codegen out_var)
    ...
    foreach(_required IDL CPP_OUT)
        if(NOT IPC_${_required})
            message(FATAL_ERROR "steamflipper_add_ipc_codegen requires ${_required}")
        endif()
    endforeach()

    if(NOT TARGET ipc_codegen)
        message(FATAL_ERROR
            "steamflipper_add_ipc_codegen: target 'ipc_codegen' is not defined; "
