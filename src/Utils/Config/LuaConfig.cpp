...
namespace LuaConfig{
    ...
    static bool ParseUInt64Decimal(const char* text, uint64_t* out) {
        ...
        const auto parsed = SFPlatform::Numbers::ParseUInt64(text);
    ...
    static uint8 ParseHexByte(std::string_view text) {
        return SFPlatform::Numbers::ParseHexUInt8(text).value_or(0);
    }
    ...
    static int lua_http_get(lua_State* L) {
        ...
        auto r = SFPlatform::Http::Execute(L"GET", luaL_checkstring(L, 1),
    ...
    static int lua_http_post(lua_State* L) {
        ...
        auto r = SFPlatform::Http::Execute(L"POST", luaL_checkstring(L, 1),
