...
//
// General macros  →  <steam>/steamflipper/main.log
// Module macros   →  <steam>/steamflipper/<module>.log
//
// Adding a new module logger:
//   1. Add  SF_MOD(NewMod, "newmod")  in LogModules.def.
...
namespace Log {
    ...
    // Route SFPlatform's logging facade into the host's "platform" logger.
    ...
    #define SF_MOD(v, f) inline std::shared_ptr<spdlog::logger> v;
...
#else  // STEAMFLIPPER_LOGGING_ENABLED

#include "SFPlatform/include/DynamicLibrary.h"

namespace Log {
    inline void Init(SFPlatform::DynamicLibrary::ModuleHandle) {}
...
// Generated header has its own #ifdef STEAMFLIPPER_LOGGING_ENABLED guard.
