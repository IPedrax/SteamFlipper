...
#include "SFPlatform/include/Trap.h"
...
namespace VehCommon {
    ...
    template<typename T>
    inline T GetArg(SFPlatform::Trap::Context& ctx, int index) {
    ...
    struct Int3Site {
        ...
        bool        persistent;
        void      (*onHit)(SFPlatform::Trap::Context& ctx, const Int3Site& site);
    ...
    inline void CaptureRcxTo(SFPlatform::Trap::Context& ctx, const Int3Site& site) {
