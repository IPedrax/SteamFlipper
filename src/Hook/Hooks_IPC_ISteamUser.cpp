...
namespace Hooks_IPC_ISteamUser {
    void Register() {
        IPCHandlerEntry UserEntries[] = {
            ADD_IPC_PSF_HANDLER(IClientUser, GetSteamID),
            ADD_IPC_PSF_HANDLER(IClientUser, GetAppOwnershipTicketExtendedData),
            ADD_IPC_PSF_HANDLER(IClientUser, RequestEncryptedAppTicket),
            ADD_IPC_PSF_HANDLER(IClientUser, GetEncryptedAppTicket),
        };
